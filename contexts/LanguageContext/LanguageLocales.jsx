export const translations = {
  ...
  'retake.subtitle': 'Bắt đầu lại với một cây mới',
  'retake.warning': '⚠️ Quan trọng: Hành động này sẽ:',
  'retake.reset': 'Đặt lại cây về hạt giống',
  'retake.clearPoints': 'Xóa toàn bộ điểm phát triển (điểm cảm xúc)',
  'retake.removeMessages': 'Xóa tất cả lời động viên',
  'retake.chooseNew': 'Cho phép bạn chọn tính cách cây mới',
  'retake.freshStart': 'Đây là một khởi đầu mới ✨',
  'retake.confirm': 'Đúng, làm mới hạt giống',
  'retake.cancel': 'Hủy',
  'retake.wait': '🕐 Vui lòng chờ',
  ...
  'shared.sendMessage': 'Gửi một lời động viên để giúp cây của họ phát triển!',
  'shared.yourTree': '✨ Đây là cây của bạn! Hãy chia sẻ liên kết để nhận động viên.',
  'shared.cannotSend': 'Bạn không thể tự gửi động viên cho cây của mình',
  'shared.loading': 'Đang tải cây...',
  'shared.oops': '😔 Rất tiếc!',
  'shared.goToTree': 'Đi đến cây của bạn',
  ...
  'reports.level': 'Mức độ',
  'reports.feeling': 'Cảm xúc',
  ...
  'reports.startLogging': 'Hãy bắt đầu ghi nhận để xem thống kê tại đây',
  'reports.monthlyReport': 'Báo cáo tháng',
  'reports.dailyLog': 'Ghi nhận hàng ngày',
  'reports.average': 'Trung bình',
  'reports.bestDay': 'Ngày tốt nhất',
  'reports.toughestDay': 'Ngày khó khăn nhất',
  'reports.mostCommonFeelings': 'Cảm xúc xuất hiện nhiều nhất',
  'reports.biggestImpacts': 'Yếu tố ảnh hưởng lớn nhất',
  'reports.times': 'lần',
  'reports.noDataThisMonth': 'Không có dữ liệu trong tháng',
  'reports.checkInRegularly': 'Ghi nhận thường xuyên để xem thống kê',

  // Collection
  'collection.myCollection': 'Bộ sưu tập của tôi',
  'collection.fruits': 'Trái cây',
  'collection.exchange': 'Đổi quà',
  'collection.noFruits': 'Chưa có trái cây!',
  'collection.visitTrees': 'Hãy thăm các cây để thu thập trái',
  'collection.collectibles': 'Vật phẩm',
  'collection.noCollectibles': 'Chưa có vật phẩm!',
  'collection.exchangeMore': 'Đổi trái cây để mở khóa vật phẩm',
  'collection.exchange.btn': 'Đổi',
  'collection.notEnough': 'Không đủ trái cây',

  // Fruit Display
  'fruitdisplay.collected': 'Đã thu thập',
  'fruitdisplay.collectFail': 'Thu thập thất bại. Vui lòng thử lại.',
  ...
  'description.angry': 'Tức giận',
  'description.lonely': 'Cô đơn',
  'description.overwhelmed': 'Quá tải',
  'description.frustrated': 'Bực bội',
  ...
  // Descriptions - High
  'description.happy': 'Hạnh phúc',
  'description.excited': 'Hào hứng',
  'description.energetic': 'Tràn năng lượng',
  'description.grateful': 'Biết ơn',
  'description.confident': 'Tự tin',
  'description.motivated': 'Có động lực',
  'description.joyful': 'Vui vẻ',
  ...
  // Questions
  'emotion.question.feeling': 'Bạn đang cảm thấy thế nào?',
  'emotion.question.describe': 'Điều gì mô tả chính xác nhất?',
  'emotion.question.impact': 'Điều gì ảnh hưởng đến bạn nhiều nhất?',
  'emotion.question.context': 'Muốn thêm chi tiết không?',

  // Hints
  'emotion.hint.slider': 'Kéo thanh để mô tả cảm xúc',
  'emotion.hint.selectAll': 'Chọn tất cả những gì phù hợp',
  'emotion.hint.selectUpTo3': 'Chọn tối đa 3 yếu tố',
  'emotion.hint.optional': 'Tùy chọn',

  // Actions
  'emotion.action.save': 'Lưu ghi nhận',
  'emotion.bonusPoints': 'điểm thưởng!',
  'emotion.scale.unpleasant': 'Khó chịu',
  'emotion.scale.pleasant': 'Dễ chịu',
  'emotion.placeholder.context': 'Bạn đang nghĩ gì?...',

  // Summary
  'emotion.summary.title': 'Tóm tắt ghi nhận:',
  'emotion.summary.impact': 'Ảnh hưởng',
  'emotion.summary.score': 'Điểm ước tính',

  // Community Garden
  'garden.title': 'Vườn Cộng Đồng',
  'garden.subtitle': 'Không gian chung cho hy vọng và sự tích cực',
  'garden.messages': 'tin nhắn',
  'garden.growingTogether': 'Cùng nhau trưởng thành',
  'garden.page': 'Trang',
  'garden.of': 'trên',
  'garden.noMessages': 'Hãy là người đầu tiên gieo một thông điệp!',
  'garden.leaveMessage': 'Để lại lời nhắn',
  'garden.info1': '💫 Chia sẻ suy nghĩ, động viên hoặc lời nhắn tích cực',
  'garden.info2': '🌱 Mỗi lời nhắn giúp khu vườn cộng đồng nở rộ',
  'garden.info3': '💖 Nhấn vào tin nhắn để thích hoặc trả lời',
}
