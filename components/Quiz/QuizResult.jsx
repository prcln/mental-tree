...
const QuizResult = ({ result, onContinue, onRetake }) => {
  ...
  const resultImages = {
    ...
    greenApple: greenappleResult, // Replace with: greenAppleResult
    mango: mangoResult, // Replace with: mangoResult
    strawberry: strawberryResult, // Replace with: strawberryesult
    pineapple: pineappleResult, // Replace with: pineappleResult
    cherry: cherryResult, 
  };
      ...
      <div style={{
        ...
        <div style={{
          ...
          <button
            ...
            onMouseLeave={(e) => {
              e.target.style.background = 'linear-gradient(to right, #22c55e, #16a34a)';
              e.target.style.transform = 'scale(1)';
            }}
          >
            <span>🌱</span>
